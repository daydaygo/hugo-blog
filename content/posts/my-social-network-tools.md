...
- AI工程化落地咨询: 可分享LLM Agent编排、多模态数据处理、agent应用云端部署(AWS/Aliyun)及HIPAA合规认证的一手实战经验与避坑指南(基于盛大AI项目/光年触达AI营销项目)
...
- 开源项目
  - Hyperf: GitHub星数第一的PHP协程微服务框架.可作为企业技术选型的可靠选项,您可提供核心技术支持
...
- AI工程化: Agent、RAG高级架构、模型评测与切换、提示词工程
...
- **大厂技术圈**: 前盛大、得物、趣头条、小鱼金服等公司的优秀技术骨干与管理者
  - 得物/b站/字节等大厂 产研团队管理/组织变革/aicoding落地
...
- 马拉松训练体系: 全马PB 3:28,可分享从0到全马的训练计划、伤病预防、营养补给策略(基于10年+跑步经验)
